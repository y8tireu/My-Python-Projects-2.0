...
class Player:
    ...
    def _is_colliding(self, opponent: "Player") -> bool:
        ...
        return (my_coords[0] < opp_coords[2] and my_coords[2] > opp_coords[0] and
...
class FightingGame:
    ...
    def new_game(self) -> None:
        ...
        self.canvas.coords(self.player1.id, 100, 300, 150, 360)
        self.canvas.coords(self.player2.id, 600, 300, 650, 360)

        # Clear previous winner text
